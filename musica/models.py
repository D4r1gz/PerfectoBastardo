...
class TipoEvento(models.Model):
    idEvento = models.IntegerField(
        primary_key=True, verbose_name='Id de Evento')
    nombreTipoEvento = models.CharField(
        max_length=60, verbose_name='Nombre Tipo de Evento')
...
class Evento(models.Model):
    ...
    nombreEvento = models.CharField(
        max_length=60, primary_key=True, verbose_name='Nombre Evento')
